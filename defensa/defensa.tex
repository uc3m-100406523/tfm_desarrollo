...
%
% \begin{center}
% \includegraphics[scale=0.15]{../memoria/imagenes/comunicaciones_moviles/cm_cap3_2_fixed.jpg}
% \end{center}
% \end{frame}
...
%
% 	\begin{center}
% 	\includegraphics[scale=1.0]{../memoria/imagenes/3gpp_5g_system_overview/5g-fig2.png}
% 	\end{center}
% }
...
%
% 		\begin{center}
% 		\includegraphics[scale=1.0]{../memoria/imagenes/3gpp_5g_system_overview/5g-fig5.png}
% 		\end{center}
% 	}
% 	\item {
...
%
% 		\begin{center}
% 		\includegraphics[scale=1.0]{../memoria/imagenes/3gpp_5g_system_overview/5g-fig6.png}
% 		\end{center}
% 	}
% 	\end{itemize}
% }
